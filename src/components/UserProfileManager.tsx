...
const buildFallbackProfile = (userId: string): UserProfile => ({
  ...FALLBACK_USER_PROFILE,
  userId,
  ownedAnimations: cloneOwnedAnimations(FALLBACK_USER_PROFILE.ownedAnimations),
  vehicles: FALLBACK_USER_PROFILE.vehicles.map(cloneVehicle),
  motorbikes: cloneMotorbikes(FALLBACK_USER_PROFILE.motorbikes),
  account: FALLBACK_USER_PROFILE.account
  ...
  location: FALLBACK_USER_PROFILE.location
    ...
    : undefined,
  createdAt: FALLBACK_USER_PROFILE.createdAt,
  lastLogin: FALLBACK_USER_PROFILE.lastLogin,
});
